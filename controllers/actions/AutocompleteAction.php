...
class AutocompleteAction extends Action
{
    ...
    public function run()
    {
        ...
        $selectFields = $this->select_fields ? $this->select_fields : $this->field;
        $rows = \Yii::$app->db
            ->createCommand("SELECT {$selectFields} FROM {$this->tableName} WHERE {$this->field} LIKE :field ORDER BY {$this->field}")
